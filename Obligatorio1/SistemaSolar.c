...
int main()
{
    ...
    n=10;//Numero de planetas que se quiere simular.
    d=2;//Dimensiones
    ...
    for(t=0; t<tmax; t=t+h){
        x[5][1]=r[5][1];//Se almacena el vector anterior a Verlet en x, para despues calcular si se ha dado una vuelta. 
        ...
        if(r[5][1]*x[5][1]<0 && r[5][1]>=0){//Condicional que me mira si se dio una vuelta.
