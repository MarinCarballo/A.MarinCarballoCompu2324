...
file_path = 'C:/Users/anton/OneDrive/Escritorio/A.MarinCarballoCompu2324/A.MarinCarballoCompu2324/Voluntario2/Optimizacion/Optimizacion3.csv'
...
t_ryzen_no_opt = data.iloc[:, 5]  # Nueva columna para "Ryzen 4700 U Sin optimizar"
...
plt.plot(tmax, t_ryzen_no_opt, label='Ryzen 4700 U Sin optimizar')  # Nueva línea para la nueva columna
